...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'adamyin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力成为程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://adamyin.eu.org', // 网站地址
